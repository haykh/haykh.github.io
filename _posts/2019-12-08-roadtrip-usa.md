---
layout: post
title:  "Road trip in the Eastern US [or] Parks and falls, y'all"
date:   2019-08-12 20:03:00 -0400
categories: Travel
...
> All of the photos below were made by either Arina or me, feel free to use them as your wallpapers, covers, or pretend you took them, we really don't care (if you need high-res version, reach me out). Fuck the copyright. _Most of them are also scrollable._

<div id="map" class="mapscrolloff" onclick="mapScrollOn()" onmouseleave="mapScrollOff()" >
...
<div class="parallax" style='background-image:url("https://live.staticflickr.com/65535/48524334046_3f1028d0a6_o_d.jpg");'>
  <h1>Along the Blue Ridge parkway</h1>
</div>
...
{% include slider.html selector="slider20191208a" %}

<br>

{% include slider.html selector="slider20191208b" %}

<br>

{% include slider.html selector="slider20191208c" %}

<br>

<div class="cover" style='background-image:url("https://live.staticflickr.com/65535/48524332746_2addd1d611_k_d.jpg");'></div>

<br>

{% include slider.html selector="slider20191208d" %}

<br>

{% include slider.html selector="slider20191208e" %}

<br>

{% include slider.html selector="slider20191208f" %}

<br>

<div class="parallax" style='background-image:url("https://live.staticflickr.com/65535/48524330301_937d3658d1_k_d.jpg");'>
...
{% include slider.html selector="slider20191208g" %}

<br>

Along with the great nature, you can also see the actual (partially conserved) houses and farms of the [first settlers](https://www.wikiwand.com/en/Cades_Cove#/European_settlement) in this area called the Cades Cove.

<br>

{% include slider.html selector="slider20191208h" %}

<br>

<div class="parallax" style='background-image:url("https://live.staticflickr.com/65535/48524329081_0eaba81958_k_d.jpg");'>
  <h1>Niagara Falls</h1>
</div>
...
{% include slider.html selector="slider20191208i" %}

<br>

{% include slider.html selector="slider20191208j" %}
